...
def after_install(options, home_dir):
    ...
    reqs = ['numpy', 'scipy', 'docutils==0.6', 'Pyevolve==0.6', 'newsumt==1.1.0', 'Pygments==1.3.1', 'ordereddict==1.1', 'conmin==1.0.1', 'networkx==1.3', 'PyYAML==3.09', 'Jinja2==2.4', 'decorator==3.2.0', 'Traits==3.3.0', 'Sphinx==1.0.6', 'Fabric==0.9.3', 'paramiko==1.7.6', 'pycrypto==2.3', 'zope.interface==3.6.1', 'pyparsing==1.5.2', 'virtualenv==1.6.1', 'nose==0.11.3']
