...
class Adder(Component):
    ...
    x1 = Float(0., io_direction='in')
    x2 = Float(0., io_direction='in')
    sum = Float(0., io_direction='out')
...
class ExprComp(Component):
    ...
    x = Float(0., io_direction='in')
    f_x = Float(0., io_direction='out')
    expr = Str('', io_direction='in')
...
class ExprComp2(Component):
    ...
    x = Float(0., io_direction='in')
    y = Float(0., io_direction='in')
    f_xy = Float(0., io_direction='out')
    expr = Str('', io_direction='in')
